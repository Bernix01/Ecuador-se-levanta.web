  ...
  class MainDonarComponent {
    constructor($scope) {
      ...
      $scope.data = [{
        ...
        info: "Trabajar en el levantamieto de viviendas e infraestrura en las zonas afectadas, en coordinación conjunta con ONG’s autorizadas y gobierno local.\n\nSe desarrollarán estructuras de diferentes usos como polideportivos y centros culturales comunitarios, guarderías, escuelas, centros de emprendimiento y capacitación para el área social.\n\nEn el ámbito de vivienda 'Desafío Ecuador' está interviniendo principalmente en las áreas donde los damnificados son dueños de su lote, información que corroboramos con los gobiernos locales.\n\nEstamos trabajando en 5 modelos sostenibles elaborados con materiales de la zona y fáciles de construir, para realizarlo entre diez personas y levantarla con el apoyo de toda la comunidad. Trabajamos con un grupo de arquitectos especialistas en auto sustentabilidad y compromiso con el medio ambiente.\n\nLas viviendas serán activadores económicos, ya que muchos damnificados tenían sus edificaciones organizadas en uso mixto con negocios en la planta baja y vivienda en el segundo. "
      }, {
